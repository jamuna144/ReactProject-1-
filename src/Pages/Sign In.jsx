    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-lg">
        ...
        <div className="rounded-4xl border border-white/15 bg-white/95 p-8 text-slate-900 shadow-[0_30px_100px_rgba(15,23,42,0.45)] backdrop-blur-xl sm:p-10">
          <div className="mb-8 flex items-center justify-between rounded-2xl border border-cyan-200/70 bg-cyan-50 px-4 py-3 text-sm text-cyan-900">
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-cyan-600">
                Reader first
              </p>
              <p className="mt-1 font-medium text-cyan-950">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-cyan-400 focus:ring-4 focus:ring-cyan-100"
              />
              {errors.email && (
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center text-slate-700">
                <input
                  type="checkbox"
                  className="mr-2 h-4 w-4 cursor-pointer rounded border-slate-300 text-cyan-500 focus:ring-cyan-200"
                />
                Remember me
              </label>
              <Link
            ...
            <button
              type="submit"
              className="mt-6 w-full rounded-2xl bg-linear-to-r from-cyan-500 via-sky-500 to-emerald-500 py-3 font-bold text-white shadow-lg shadow-cyan-500/30 transition duration-300 hover:brightness-110"
            >
              Sign In
            </button>
          </form>
