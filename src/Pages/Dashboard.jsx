...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#6b3c0c] via-[#fffaf5] to-[#e8d5c4] p-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-10">
        ...
        <input
          ...
          className="px-5 py-3 rounded-2xl border shadow-md w-[280px] focus:ring-2 focus:ring-orange-300 outline-none"
        />
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        {stats.map((item, index) => (
          <div
            key={index}
            className={`bg-gradient-to-r ${item.color} p-6 rounded-3xl shadow-lg hover:scale-105 transition`}
          >
      ...
      <div className="grid md:grid-cols-2 gap-8 mt-10">
        ...
        <div className="bg-[#f2e6d8] p-6 rounded-3xl">
          <h2 className="font-bold text-[#4b2e2e] text-xl">
            Announcements
          </h2>
          <p className="mt-2 text-gray-700">
