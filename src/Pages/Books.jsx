...
//             Learn, explore, and grow your knowledge every day.
//           </p>

//           <button
//             onClick={() => navigate("/")}
//             className="mt-6 px-7 py-3 bg-[#c4a85c] text-black font-medium rounded-full hover:scale-105 transition"
//           >
//             Back to Home
//           </button>
//         </div>
...
//         text="A rich collection of novels and fictional stories that inspire imagination, creativity, and emotional connection through storytelling."
//         reverse={false}
//       />
...
//         text="Explore historical books that reveal ancient civilizations, world events, and human evolution through time."
//         reverse={true}
//       />
...
//         text="Discover poetry, literature, and artistic works that reflect human creativity, culture, and expression."
//         reverse={false}
//       />
...
//         img={Biography}
//         title="Biographies"
//         text="Learn from the life stories of great personalities and gain inspiration from their journeys and achievements."
//         reverse={true}
//       />
...
//         text="Expand your knowledge of physics, chemistry, biology, and modern scientific discoveries."
//         reverse={false}
//       />
...
//         text="Stay updated with programming, AI, cybersecurity, and modern technological advancements."
//         reverse={true}
//       />
...
//         text="Support your studies with textbooks, notes, and academic materials for better learning outcomes."
//         reverse={false}
//       />
...
//         text="Learn business strategies, finance, entrepreneurship, and economic principles for real-world success."
//         reverse={true}
//       />
...
//         src={img}
//         alt={title}
//         className="w-full md:w-1/2 h-48 md:h-64 object-cover rounded-xl shadow-lg"
//       />

//       <div className="md:w-1/2">
//         <h2 className="text-4xl font-bold mb-4">{title}</h2>

//         <p className="text-gray-600 md:text-xl leading-relaxed font-medium">
//           {text}
//         </p>
